...
from dataloader.oxford import OxfordDataset
...
class BatchSampler(Sampler):
    ...
    def __init__(self, dataset: OxfordDataset, batch_size: int, batch_size_limit: int = None,
        ...
        # self.generate_batches() # 初始化batch_idx
    ...
    def expand_batch(self):
        ...
        log_string('=> Batch size increased from: {} to {}'.format(old_batch_size, self.batch_size))
...
if __name__ == '__main__':
    ...
    ds = OxfordDataset(config, query_filename)
